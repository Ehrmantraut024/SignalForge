...
def reward_function(antenna_positions, theta_steer=0):
    """Compute the signal intensity at the target point for a specific steering angle."""
    global positions
...
def genetic_algorithm_with_improvements(num_generations, population_size, num_antennas):
    """Run the Genetic Algorithm (GA) with improved fitness maximization."""
    global positions
